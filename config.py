...
class Settings(BaseSettings):
    NEO4J_URI: str = "neo4j+s://f53b330b.databases.neo4j.io"
    NEO4J_USERNAME: str = "neo4j"
    NEO4J_PASSWORD: str = "2wF3LzlTKmyQTGmDZ2XM6EprUytOBqgt6waF-B-SQXY"
    AURA_INSTANCEID: str = "f53b330b"
    #AURA_INSTANCENAME: str ="Free instance"
    ...
    @field_validator('NEO4J_USERNAME', 'NEO4J_PASSWORD', 'AURA_INSTANCEID', 
